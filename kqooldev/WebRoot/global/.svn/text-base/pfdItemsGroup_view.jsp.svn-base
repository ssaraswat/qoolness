...
String yesStr="Yes";
if (highlightTrueMedicalConditionBooleans) {
	yesStr="<span style=\"color:#cc0000; font-weight:bold;\">"+yesStr+"</span>";
}
...
for (int i=0; i<group.length; i++) {
	...
	<td valign="top" nowrap="nowrap" width="80" class="bodyFont" align="right"><nobr><%=currentData.getCurrentItemValue(group[i]).equals("true")?yesStr:"No"%><br/></nobr></td>
	</tr>
	<tr>
